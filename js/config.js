...
export const i18n = {
    pl: {
        ...
        salaryStatsTitle: 'Podsumowanie miesiąca',
        workDays: 'Dni pracy',
vacationDays: 'Urlop',
sickDays: 'Choroba',
...
transReceived: 'Data nadania',
transMonth: 'Miesiąc rozliczenia',
    },
    uk: {
        ...
        salaryStatsTitle: 'Підсумок місяця',
        workDays: 'Робочі дні',
vacationDays: 'Відпустка',
sickDays: 'Хвороба',
otherBonus: 'Інші доплати',
projectedSalary: 'Прогнозована',
actualSalary: 'Фактична',
difference: 'Різниця',
transactions: 'Виплати',
bonuses: 'Доплати',
actualYearly: 'Фактична річна',
transReceived: 'Дата надходження',
transMonth: 'Місяць розрахунку',
    }
};
